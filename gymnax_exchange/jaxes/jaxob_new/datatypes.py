...
class OrderBook():
    ...
    def vprocess_mult_order_arrays(self,single_array):
        msg_arrays=jnp.stack([single_array]*100000,axis=2)
        bidsides=jnp.stack([self.bids]*100000,axis=0).astype("int32")
        asksides=jnp.stack([self.asks]*100000,axis=0).astype("int32")
