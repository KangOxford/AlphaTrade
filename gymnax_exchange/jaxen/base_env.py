...
class BaseLOBEnv(environment.Environment):
    ...
    """
    def __init__(self,cfg:Configuration, key, alphatradePath, window_selector, sliceTimeWindow, trader_unique_id= -9999999, ep_type="fixed_time"):
        super().__init__()
        ...
        self.tick_size=100
        self.start_resolution=60*60*3 #Interval in seconds at which eps start
        self.cfg = cfg
