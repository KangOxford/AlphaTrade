...
def main():
    ...
    output_file_path = "/home/myuser/gymnax_exchange/jaxen/Timing_speed/timing_results3.txt"
   ...
   # num_steps_options = [1000, 5000]
    ...
    df.to_csv("/home/myuser/gymnax_exchange/jaxen/Timing_speed/timing_results3.csv", index=False)
