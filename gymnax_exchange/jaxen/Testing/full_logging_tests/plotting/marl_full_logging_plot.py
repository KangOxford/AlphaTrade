...
def plot_buy_sell_task_size(env_data_df, trades_df, output_dir, trader_id=10):
...
plot_buy_sell_inventory_networth(mm_env_data, trades_df,  output_dir, config["MM_TRADER_ID"])
plot_agent_prices_reward(mm_env_data, messages_df, mm_reward_df, output_dir, config["MM_TRADER_ID"])

plot_buy_sell_task_size(exec_env_data, trades_df, output_dir, config["EXE_TRADER_ID"])
