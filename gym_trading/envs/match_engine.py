...
class Core():
    ...
    def step(self, action):
        ...
        state = sorted(state, reverse = True) # state is the original observation
        diff_obs = self.get_difference(Flag.skip) # get incomming orders from data
        to_be_updated = self.update(diff_obs, new_obs) # new_obs is generated by action
        ...
        if type(updated_state) == list:
            ...
            print('to be updated', to_be_updated) # tbd
...
if __name__ == "__main__":
    ...
    for i in range(10):
        obs = core.step(1)[0]
    # ==================================================
    obs125= core.step(min(20,core.get_ceilling()))[0]
    obs126 = core.step(300)[0]
    # ==================================================
