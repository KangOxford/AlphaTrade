...
class Action(BaseAction): # more precise class name: DeltaAction
    ...
    #     price_delta = self.price_delta + Config.price_delta_size_one_side
    ...
    #     quantity_delta = self.quantity_delta +  Config.quantity_size_negative_side
    ...
    #     quantity_delta = action[1] - Config.quantity_size_negative_side
