...
def plot_render(self):
    ...
    # ax.plot(pd.Series(mid_prices), label="mid_price", color='darkorange', linestyle = "--", dashes=[0.25, 0.25], linewidth=0.25)
    # ax.plot(pd.Series(mid_prices), label="mid_price", color='darkorange', linestyle = ":", dashes=[1, 1.5], linewidth=1.0)
    # ax.plot(pd.Series(mid_prices), label="mid_price", color='darkorange', linestyle = ":", dashes=[1, 1.0], linewidth=1.0)
