...
class DataPipeline:
    def __init__(self):
        if Config.Adapter.raw_price_level == 10:
        ...
        elif Config.Adapter.raw_price_level == 50:
    ...
    def __call__(self):
        ...
        return {'price_level':Config.Adapter.raw_price_level, 
                'horizon':Config.Adapter.raw_horizon, 
