...
class DataAdjuster():
    def __init__(self, d2 = None, l2 = None):
        ...
        self.adjust_data_drift_id_bid = 10000000  # caution about the volumn for valid numbers
        self.adjust_data_drift_id_ask = 20000000  # caution about the volumn for valid numbers
