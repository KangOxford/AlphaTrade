...
# Configuration
YAML_CONFIG_FILE="gymnax_exchange/jaxrl/MARL/baseline_eval/config/baseline_mm_config_bobStrategy.yaml"
JSON_CONFIG_FILE="config/env_configs/mm_bobStrategy.json"
...
YAML_VALUES="4"                 # FIXED_ACTIONS values to test (space-separated)
JSON_VALUES="0.1 0.2 0.3" #"0.1 0.15 0.2 0.3" # rebate_bps values to test (space-separated)
# ============================================================================
...
sweep_iteration() {
    ...
    RUN_OUTPUT=$(make baseline_only_bob gpu=4 2>&1)
    EXIT_CODE=$?
