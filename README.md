  ...
  * Jun.01~Jun.31
    * Jun.01-Jun.15 Experiments Implemention.
      * Experiment.01 
        ...
        * PartB `Implemented` <img width="13" alt="image" src="https://jupyter.org/assets/homepage/main-logo.svg"> [The Model-free LQR](https://github.com/KangOxford/Dissertation/blob/main/Model_Free_LQR-type1.ipynb) form Huining Yang's [paper](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=DknyNcIAAAAJ&citation_for_view=DknyNcIAAAAJ:u5HHmVD_uO8C). 
